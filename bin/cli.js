...
program
  ...
  .on('--help', function(){
    ...
    log('    ' + [
      ...
      '',
      'electrify-vidtext',
      'electrify-vidtext run',
      'electrify-vidtext package',
      'electrify-vidtext package -o /dist/dir',
      'electrify-vidtext package -o /dist/dir -s file.json',
      'electrify-vidtext package -i /app/dir -o /dist/dir -s dev.json',
      'electrify-vidtext package -- <electron-packager-options>',
      '',
